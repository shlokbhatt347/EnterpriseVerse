...
export interface SimulationState { business: Business; operations?: OperationsState; market?: MarketState; agents?: AgentWorldState; events: SimulationEvent[]; log: string[]; }
