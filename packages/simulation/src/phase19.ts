...
export type PersonalityAxis19 = "risk" | "innovation" | "priceFocus" | "qualityFocus" | "growth" | "patience" | "aggression" | "ethics" | "adaptability" | "customerFocus";
export type CompetitorStrategy19 = "price" | "quality" | "growth" | "niche";
export type IntelligenceTier19 = "beginner" | "average" | "smart" | "expert" | "elite";
export type MarketTrend19 = "boom" | "growing" | "stable" | "softening" | "recession";
export interface Personality19 { id: string; name: string; traits: Record<PersonalityAxis19, number>; riskTolerance: "low" | "medium" | "high"; intelligence: IntelligenceTier19; strategyBias: CompetitorStrategy19; }
export interface CompetitorProfile19 extends Personality19 { companyName: string; startingCash: number; startingMarketShare: number; }
