...
export default function IntelligencePage() {
  ...
  return <main className="intelligence-page">
    <header className="intel-header">
      <div>
        <Link className="intel-brand" href="/">ENTERPRISEVERSE</Link>
        <div className="intel-eyebrow">PHASE 6 · ENTERPRISE INTELLIGENCE</div>
        <h1>{state.business.name} command center</h1>
        <p>Evidence-based guidance, role-aware analysis and safe what-if scenarios built directly from your simulation state.</p>
      </div>
      <div className="intel-header-actions"><Link className="intel-secondary" href="/learning">Learning hub</Link><Link className="intel-secondary" href="/">Back to simulation</Link></div>
    </header>
    ...
    <section className="intel-grid">
      ...
      <article className="intel-card scenario-card">
        ...
        <p>These projections are calculated from the current simulation and never change your real company.</p>
