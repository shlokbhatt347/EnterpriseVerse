...
export default function CompetitionPage() {
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => { void refreshRoom(room.id).catch(() => undefined); }, 2000);
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => { void refreshNetwork().catch(() => undefined); }, 6000);
    return () => window.clearInterval(timer);
  }, [refreshNetwork, user]);
