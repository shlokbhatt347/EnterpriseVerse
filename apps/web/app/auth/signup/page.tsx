...
export default function SignUpPage() {
  ...
  return <main className="auth-page">
    <section className="auth-card" aria-labelledby="signup-title">
      ...
      <h1 id="signup-title" className="auth-title">Create your player account.</h1>
      <p className="auth-copy">Build a company, develop a career, join teams and keep your simulation progress connected.</p>
