...
export default function LearningHubPage() {
  ...
  if (loading || !state) {
    return <main className="learning-page"><section className="learning-card"><p>{error ?? "Loading your founder profile and enterprise context…"}</p><Link className="learning-back" href="/founder">Open Founder Mode →</Link></section></main>;
  }

  return (
    <CanonicalShell state={state} syncStatus={status}>
      <main className="learning-page">
        <header className="learning-header"><div><div className="eyebrow">EnterpriseVerse · Phase 23</div><h1>Train your founder judgement.</h1><p>Every challenge adapts to what you do well, what you miss and what the business world is asking from you next.</p></div><div className="learning-header-actions"><Link className="learning-back" href="/intelligence">Enterprise Intelligence →</Link><Link className="learning-back" href="/day1">Back to enterprise</Link></div></header>
